...
//   );
  ...
  return (
    <ScrollView  >
      <View style={styles.formContainer} className="my-8 mx-3">
        <ShippingInfo
      ...
      <TouchableOpacity style={styles.paymentButton} onPress={paymentSubmit}>
...
const ShippingInfo = ({
    // user,
  phoneNumber, setPhoneNumber, country, setCountry, city, setCity, 
  ...
  return (
    <View style={styles.shippingContainer} >
      ...
      <View style={styles.inputGroup}>
        <TextInput style={styles.input} placeholder="Full Name" editable={false} />
        {/* value={user?.name}  */}
        <TextInput style={styles.input} placeholder="Email Address"  editable={false} />
        {/* value={user?.email}/ */}
      </View>
      ...
      <View style={styles.inputGroup}>
        <TextInput style={styles.input} placeholder="Address1" value={address1} onChangeText={setAddress1} />
        <TextInput style={styles.input} placeholder="Address2" value={address2} onChangeText={setAddress2} />
      </View>
...
const CartData = ({ totalPrice, shipping, subTotalPrice }) => {
  return (
    <View style={styles.cartContainer} className="  mx-10 mt-6 pb-4 shadow-slate-600b bg-red-100 rounded-lg">
...
const styles = StyleSheet.create({
  container: {
    flex: 1, padding: 16,marginTop:28, backgroundColor: "#f5f5f5"
  },
  formContainer: {
    backgroundColor: "#fff", paddingHorizontal:16 , borderRadius: 8
  },
  heading: {
  ...
  input: {
    flex: 1, padding: 10, borderWidth: 1, borderColor: "#ccc", borderRadius: 5, marginRight: 5
  },
  shippingContainer: {
    marginBottom: 0, paddingHorizontal: 16,paddingTop:16 ,backgroundColor: "#fff", borderRadius: 8
  },
  cartContainer: {
    paddingHorizontal: 16,paddingTop:16 ,  marginBottom: 20
  },
  summaryText: {
    fontSize: 16, fontWeight: "bold", marginVertical: 5
  },
  linkText: {
    color: "#f63b60", marginTop: 10, fontSize: 16
  },
  paymentButton: {
    backgroundColor: "#f63b60", borderRadius: 8,height:35,width:220, alignItems: "center", marginLeft: "auto", marginRight: "auto"
  },
  paymentButtonText: {
